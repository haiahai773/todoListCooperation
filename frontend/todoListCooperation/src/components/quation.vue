        ...
        <div class="quation-top">
            <div class="quation-topleft quation">
                ...
                <div class="list" ref="TL">
                    <div class="list-list__item" v-for="(item, index) in Quation.topleftList" :key="item.todo_id">
            ...
            <div class="quation-topright quation">
                ...
                <div class="list" ref="TR">
                    <div class="list-list__item" v-for="(item, index) in Quation.topRightList" :key="item.todo_id">
        ...
        <div class="quation-bottom">
            <div class="quation-bottomleft quation">
                ...
                <div class="list" ref="BL">
                    <div class="list-list__item" v-for="(item, index) in Quation.bottomleftList" :key="item.todo_id">
            ...
            <div class="quation-bottomright quation">
                ...
                <div class="list" ref="BR">
                    <div class="list-list__item" v-for="(item, index) in Quation.bottomRightList" :key="item.todo_id">
