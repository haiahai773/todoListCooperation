        ...
        <div class="login-warpper__box">
            ...
            <div class="login-box">
                ...
                <div class="login-login__warpper" v-show="switchFlag">
                    ...
                    <el-input class="login-login__account login-login__input" v-model="TempData.tempLoginAccount"
                        placeholder="账号"></el-input>
                    <div class="login-login__prompt">密码：</div>
                    <el-input class="login-login__password login-login__input" v-model="TempData.tempLoginPassword"
                        placeholder="密码" show-password></el-input>
                    <el-button class="login-login__submit" type="primary" @click="loginSubmit()">登录</el-button>
                </div>
                <div class="login-login__warpper" style="display: none;" v-show="!switchFlag">
                    <div class="login-login__prompt">用户名：</div>
                    <el-input class="login-login__password login-login__input" v-model="TempData.tempRegUserName"
                        placeholder="用户名"></el-input>
                    <div class="login-login__prompt login-prompt__account">账号：</div>
                    <el-input class="login-login__account login-login__input" v-model="TempData.tempRegAccount"
                        placeholder="账号"></el-input>
                    <div class="login-login__prompt">密码：</div>
                    <el-input class="login-login__password login-login__input" v-model="TempData.tempRegPassword"
                        placeholder="密码" show-password></el-input>
                    <el-button class="login-login__submit" type="primary" @click="regSubmit()">注册</el-button>
                </div>
            </div>
        </div>
    </div>
...
const regSubmit = () => {
    ...
    //用户名校验
    if (TempData.tempRegUserName.length <= 1 || TempData.tempRegUserName.length > 8) {
        toast("用户名格式错误！", {
            "theme": "auto",
            "type": "warning",
            "transition": "slide",
